...
const Generator = (props: { getStateFunction: Function}) => {
    ...
    const [association, setAssociation] = useState("KV Mettmann");
    const [source, setSource] = useState("Quelle");
    const [background, setBackground] = useState("/77208332_2555833491170848_7632607706234224640_o-1.jpg");
    ...
    return <div id={"generator"} className={"generator " + type+ " " + design} style={{backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundImage: "url("+ background +")"}}>
        ...
        <img src={"/julis_white.svg"} className={"julilogo"}/>
